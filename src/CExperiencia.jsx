          ...
          <div className="scrollspy-example-2 text-justify" tabIndex={0} style={{ maxHeight: '400px', overflowY: 'auto' }}>
            ...
            <div id="item-4-2" ref={item42Ref}>
              ...
              <div>Mis responsabilidades se basan en cumplir a cabalidad con los proyectos que se me encomienden.
                ...
                <ul>
                  <li>Diseño y desarrollo de programas para prototipos de nueva maquinaria.</li>
                  <li>Reprogramación de maquinaria industrial.</li>
                  <li>Diseño e implementación de sistemas domóticos.</li>
                  <li>Diseño e implementación de tarjetas electrónicas, incluyendo la programación de los microcontroladores.</li>
                  <li>Mantenimiento a nivel eléctrico y electrónico de maquinaria industrial.</li>
                  <li>Diseño y programación de interfaces de usuario para HMI.</li>
                  <li>Modificación del funcionamiento de maquinaria industrial a nivel lógico, eléctrico o neumático.</li>
                  <li>Otros.</li>
                </ul>
              </div>
            </div>
